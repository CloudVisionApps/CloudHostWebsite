    ...
    'wordpress_support' => [
        'basic' => [
            ...
            'features' => [
                ...
                'Мониторинг на SSL',
                'Настройка за връзка с база от данни',
                'Настройки за сигурност',
                'Настройки на PHP',
                'Невъзможност за достъп до админ панел',
                'Невъзможност за зареждане на страница',
                'Обновяване на плъгини',
                'Смяна на основен домейн',
                'Мониторинг на сайт',
                'Обновяване на WordPress ядрото',
                'Помощ при работа с админ панела',
                'Съдействие при Error 500',
                'Създаване на Dev среда',
                'Доклад',
                'Извличане на URL адреси',
                'Изоставени плъгини',
                'Изоставени теми',
