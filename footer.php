    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20  z-10">
        ...
        <div class="grid md:grid-cols-4 gap-16 mb-20">
            ...
            <div class="col-span-2">
                ...
                <p class="text-gray-300 mb-8 text-lg leading-relaxed max-w-md"><?php echo_config('seo.description'); ?></p>
                
                <!-- Enhanced Social Media -->
                <div class="space-y-4">
                    <h5 class="text-sm font-semibold text-white/80 uppercase tracking-wider mb-4 flex items-center">
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="text-lg font-semibold mb-8 text-white flex items-center group">
