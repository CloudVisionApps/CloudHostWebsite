    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <a href="#about" class="text-gray-200 hover:text-white font-medium transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/10">За нас</a>
                <a href="#contact" class="text-gray-200 hover:text-white font-medium transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-white/10">Контакти</a>
            </div>
